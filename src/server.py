...
APP_USERNAME = os.getenv("APP_USERNAME", "face_analysis")
APP_PASSWORD = os.getenv("APP_PASSWORD", "aif_2425_app")
...
async def websocket_endpoint(websocket: WebSocket):
    ...
    import base64
    expected = "Basic " + base64.b64encode(f"{APP_USERNAME}:{APP_PASSWORD}".encode()).decode()
    if auth != expected:
